...
class TestTeamGames(UnitTest):
    def test_multiple_games(self):
        ...
        game1 = Game(home_team=team1, away_team=team2, match_day=1, start_time=1594445619)
        self.session.add(game1)
        game2 = Game(home_team=team3, away_team=team1, match_day=1, start_time=1594445620)
        self.session.add(game2)
        game3 = Game(home_team=team1, away_team=team4, match_day=1, start_time=1594445621)
        self.session.add(game3)
        game4 = Game(home_team=team4, away_team=team1, match_day=1, start_time=1594445622)
        self.session.add(game4)
        game5 = Game(home_team=team4, away_team=team2, match_day=1, start_time=1594445623)
