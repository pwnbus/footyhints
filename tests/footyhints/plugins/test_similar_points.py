...
class TestSimilarPoints(UnitTest):
    def setup(self):
        ...
        self.session.commit()
        self.total_score = SimilarPoints(self.game)

    def test_description(self):
        assert self.total_score.description == 'Proximity in points'
